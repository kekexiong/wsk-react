...
<div class="page-container">
                            ...
                            <div class="row norow">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">角色ID:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="roleId" id="ROLE_ID" class="form-control" placeholder="角色ID">
                                        </div>
                                    </div>
                                </div>
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">角色名称:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="roleName" id="ROLE_NAME" class="form-control" placeholder="角色名称">
                                        </div>
                                    </div>
                                </div>
                                                        </div>
                            ...
                            <table  class="table table-striped table-bordered table-hover table-checkable order-column" id="queryMecGrid">
                                ...
                                <tr>
                                    ...
                                    <th class="nowrap">序号</th>
                                                    <th class="nowrap">角色ID</th>
                                                    <th class="nowrap">角色名称</th>
                                                    <th class="nowrap">权限集合</th>
                                                    <th class="nowrap">状态</th>
                                                    <th class="nowrap">部门ID</th>
                                                    <th class="nowrap">备注</th>
                                                    <th class="nowrap">创建人</th>
                                                    <th class="nowrap">创建时间</th>
                                                    <th class="nowrap">更新操作人</th>
                            ...
                            <input type="hidden" value = "" id = "hiddenKey"/>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">角色ID:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="roleId" id="ROLE_ID_SHOW" class="form-control" placeholder="角色ID">
                                        </div>
                                    </div>
                                </div>
                                                                                                                             <!-- 普通输入框 -->
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">角色名称:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="roleName" id="ROLE_NAME_SHOW" class="form-control" placeholder="角色名称">
                                        </div>
                                    </div>
                                </div>
                                                                                                                             <!-- 普通输入框 -->
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">权限集合:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="scope" id="SCOPE_SHOW" class="form-control" placeholder="权限集合">
                                        </div>
                                    </div>
                                </div>
                                                                                                                                                            <!-- 下拉框 -->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">部门ID:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="deptId" id="DEPT_ID_SHOW" class="form-control" placeholder="部门ID">
                                        </div>
                                    </div>
                                </div>
                                                                                                                             <!-- 普通输入框 -->
    ...
    <!-- ---------------------------------------详情页面展示(获取输入值的输入框后缀统一增加_VIEW标识符)------------------------------------------------------------ -->
        <div class="modal fade" id="viewWin" tabindex="-1" role="dialog" data-backdrop="static" data-width="900px" data-height="700px">
            <div class="modal-header">
                            ...
                            <div class="row norow">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">角色ID:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="roleId" id="ROLE_ID_VIEW" class="form-control" disabled="disabled" placeholder="角色ID">
                                        </div>
                                    </div>
                                </div>
                                                                                                                                                                                                           <!-- 普通输入框 -->
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 text-right">角色名称:</label>
                                        <div class="col-md-8 paddingnone">
                                            <input name="roleName" id="ROLE_NAME_VIEW" class="form-control" disabled="disabled" placeholder="角色名称">
                                        </div>
                                    </div>
                                </div>
                              <div class="clearfix"></div>
                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green-sharp uppercase">系统菜单</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6" style="text-align:center;">
                                            <button type="button" id="openform_save_btn" class="btn red"> <i class="fa fa-share"></i> 保存</button>
                                        </div>
                                        <div class="col-md-6" style="text-align:center;">
...
<script type="text/javascript">
    ...
    <!--如果不需要回显第一个参数传入""，如果不需要设定disabled属性传入FALSE-->
                        <!--添加获取修改下拉框-->
        getComboStore("","STS_SHOW", "ROLE-STS","");
        //初始化输入框时间默认值方法
        initDefaultDate();
        //重置按钮
        ...
        $("#addform_save_btn").off('click').on('click', function() {
            ...
            param.roleId = $("#ROLE_ID_SHOW").val();
            param.roleName = $("#ROLE_NAME_SHOW").val();
            param.scope = $("#SCOPE_SHOW").val();
            param.sts = $("#STS_SHOW").val();
            param.deptId = $("#DEPT_ID_SHOW").val();
            param.remarks = $("#REMARKS_SHOW").val();
            var hiddenType = $("#hiddenType").val();
            var url = "";
            if("1" == hiddenType){
                url = baseURL + "/system/role/save";
            }else if ("2" == hiddenType){
                url = baseURL + "/system/role/update";
                param.roleId = $("#hiddenKey").val();
            }else{
                url = "";
            }
            $.ajax({
            ...
            if(selectRocords.length <= 0){
                ...
                bootbox.confirm("选择了"+selectRocords.length+"条, 确认删除?", function(truthBeTold){
                    if(truthBeTold){
                        $.ajax({
                            type: "POST",
                            url: baseURL + "/system/role/deleteByKey",
                            data:{
                                keys:keys
                            },
                            contentType: "application/x-www-form-urlencoded;charset=utf-8",
    ...
    function addOrUpdate(type,record){
        ...
        addOrUpdateFormValidator();
        if("add" == type){
            document.getElementById('ROLE_ID_SHOW').readOnly = false;
            ...
            $.ajax({
                type : "POST",
                url : baseURL + "/system/role/getDetail",
                data :param,
                contentType: "application/x-www-form-urlencoded;charset=utf-8",
                dataType : "json",
                success:function(data){
                    <!--修改页面展示字段-->
                                document.getElementById('ROLE_ID_SHOW').value=data.data.roleId;
                                if("update" == type){
                                    document.getElementById('ROLE_ID_SHOW').readOnly = true;
                                 }
                                document.getElementById('ROLE_NAME_SHOW').value=data.data.roleName;
                                document.getElementById('SCOPE_SHOW').value=data.data.scope;
                                getComboStore(data.data.sts,"STS_SHOW", "ROLE-STS",false);
                                document.getElementById('DEPT_ID_SHOW').value=data.data.deptId;
                                document.getElementById('REMARKS_SHOW').value=data.data.remarks;
                                document.getElementById('hiddenKey').value=data.data.roleId;
                    $("#addOrUpdateWin").modal('show');
                },
                error:function(){
                    alert("操作失败，请重新操作！")
    ...
    var queryInner_Path = baseURL + "/system/role/query";
    //实现查询按钮方法
    function reloadGrid(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.items,function(index,obj){
                        ...
                        trData.push(obj.roleId);
                        trData.push(obj.roleName);
                        trData.push(obj.scope);
                        trData.push(getCodeName("ROLE-STS", obj.sts));
                        trData.push(obj.deptId);
                        ...
                        trData.push("<a href='javascript:void(0)'  onclick=view('"+JSON.stringify(obj)+"')><i class='fa fa-search-plus'></i>权限编辑</a>");
        ...
        function view(info){
            ...
            $.ajax({
                ...
                success:function(data1){
                            document.getElementById('ROLE_ID_VIEW').value=data1.data.roleId;
                            document.getElementById('ROLE_NAME_VIEW').value=data1.data.roleName;
    ...
    //     plugins: ["wholerow", "types","checkbox"]
    // });
    $('#openform_save_btn').on('click', function () {
        debugger;
        var ref = $('#tree').jstree(true),
            sel = ref.get_selected();  // get_selected() 不加true返回的是被选中的id
        ...
        var param = {};
        param.roleId = document.getElementById('ROLE_ID_VIEW').value;
        param.scope=sel.toString()+"";
        $.ajax({
            type: "POST",
            url: baseURL + "/system/role/update",
            contentType: "application/x-www-form-urlencoded;charset=utf-8",
